...
RASPBERRIES = [
    {"name": "Refroidissement passif ♨️", "url": "http://192.168.137.10:8000/metrics/temperature"},
    {"name": "Refroidissement actif air 💨", "url": "http://192.168.137.11:8000/metrics/temperature"},
    {"name": "Refroidissement actif eau 💧", "url": "http://192.168.137.12:8000/metrics/temperature"},
]
...
def start_game():
    ...
    - (plus tard) enverra le prompt à Ollama
    ...
    # TODO: ici plus tard → appel à Ollama avec le prompt
    # ex: requests.post("http://ollama:11434/api/chat", json={...})
